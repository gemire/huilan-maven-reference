...
function CalendarInit()				///Create panel
{
	...
	htmlAll="<div id='"+this.sDIVID+"' style='display:none;position:absolute;width:180px;border:"+this.divBorderCss+";padding:1px;background-color:#FFFFFF'>";
//	htmlAll="<div id='"+this.sDIVID+"' style='display:none;position:absolute;width:"+this.Width+";border:"+this.divBorderCss+";padding:2px;background-color:#FFFFFF'>";
	...
	for(i=0;i<=6;i++)
	{
		...
		for(j=0;j<7;j++)
		{
			...
			if(i==0)
			{
				htmloDayTable+="<td height='14' align='center' valign='middle' style='cursor:hand'>";
