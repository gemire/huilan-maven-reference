...
<body bgcolor="#EEEEEE" Scroll="no">
    ...
    <form name="form1" method="post" action="Messages.aspx?OPID=05638" id="form1">
    <div>
      ...
      <tr>
        <td background="${ctx}/Manager/images/MessageIcon/MessageBody.gif"><table width="100%" style="table-layout:fixed;"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td align="left">
            <c:if test="${! empty mbx._M_ButtonList}">
            <c:forEach var="item" items="${mbx._M_ButtonList}" varStatus="status">     
      <input type='button' ID='Message_Button${status.count-1}' class='button_bak' onClick="JavaScript:window.location.href='${item._btnUrl}';" value='${item._btnText}' title='${item._btnHint}'/>
</c:forEach>
            </c:if>            
            </td>
            <td>&nbsp;</td>
