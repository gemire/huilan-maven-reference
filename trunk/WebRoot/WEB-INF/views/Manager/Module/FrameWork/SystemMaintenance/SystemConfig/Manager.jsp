...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              <tr>
                <td class='menubar_title'><img border='0' src='${ctx}/Manager/images/ICON/config.gif' align='absmiddle' hspace='3' vspace='3'>&nbsp;系统环境配置</td>
              ...
              <tr>
                ...
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='Default';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${ctx}/Manager/images/ICON/back.gif">&nbsp;返回</td></tr></table></td>
              </tr>
    ...
    <!-- 选项卡 Start -->
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${ctx}/Manager/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>系统配置</TD>
        ...
        <form:form modelAttribute="sysinfo">  
                <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                    <tr>
                        <td class="table_body">
                            系统名称</td>
                        <td class="table_none">
                            <form:input path="sname" cssStyle="width:250px;" /><span class="required">* 必填</span>
                       <form:errors path="sname" cssClass="error" /></td>
                    </tr>
                    <tr>
                        <td class="table_body">
                            框架版本</td>
                        <td class="table_none">
                            <form:input path="sversion" cssStyle="width:100px;" /><span class="required">* 必填</span>
                       <form:errors path="sversion" cssClass="error" /></td>
                    </tr>
                    <tr>
                        <td class="table_body">
                            官方网站</td>
