...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              <tr>
                <td class='menubar_title'><img border='0' src='${ctx}/Manager/images/ICON/user.gif' align='absmiddle' hspace='3' vspace='3'/>&nbsp;用户资料管理</td>
              ...
              <tr>
                ...
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='Manager?cmd=new';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${ctx}/Manager/images/ICON/new.gif">&nbsp;新增用户</td></tr></table></td>
              </tr>
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${ctx}/Manager/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>用户资料列表</TD>
 ...
 SysUser sysUser=null;
  ...
  while(it.hasNext())
  {
    ...
    <tr class="<%=seq%2==1?"row":"row1"%>" align="center" style="height:28px;">
			<td><%=sysUser.getUuserNo()%></td>
			<td><%=sysUser.getUloginName()%></td>
			<td><%=sysUser.getUcname()%></td>
			<td><%=strArray[sysUser.getUstatus()]%></td>
			<td><a href="Manager?cmd=edit&IDX=<%=sysUser.getUserId()%>">编辑</a>||<a href="JavaScript:DelData('Manager?cmd=del&IDX=<%=sysUser.getUserId()%>')">删除</a></td>
		</tr>
    <%
