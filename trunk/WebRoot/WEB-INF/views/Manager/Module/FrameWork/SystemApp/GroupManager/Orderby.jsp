...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              ...
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：部门排序</td>
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='GroupList.aspx?GroupID=${param.GroupID}';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${ctx}/Manager/images/ICON/back.gif">&nbsp;返回</td></tr></table></td>
              </tr>
    ...
    <!-- 选项卡 Start -->
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${ctx}/Manager/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>排序</TD>
        ...
        <form action="${ctx}/Manager/Module/FrameWork/SystemApp/GroupManager/Orderby?GroupID=${param.GroupID}" method="post">
          <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center" >
          <tr class="table_title">
            <td>
                <span id="ctl00_PageBody_CatListTitle">${grouptitle}</span>
            </td>
          </tr>
          <tr class="table_none">
            <td align="center">
                ...
                <tr>
                    <td>
               <select size="1" name="OrderByListItems" multiple="multiple" id="OrderByListItems" style="height:160px;width:120px;">
	<c:if test="${! empty sysGroup.subSysGroups}">
           <c:forEach var="group" items="${sysGroup.subSysGroups}" varStatus="status">
             <option value="${group.groupId}">${group.gcname}</option>
           </c:forEach>
         </c:if>
</select>
</td>
          ...
          <tr><td align="right">
          <input type="submit" name="ctl00$PageBody$Button2" value="确定" onclick="selectAll(OrderByListItems);" id="ctl00_PageBody_Button2" class="button_bak" />
          </td></tr>
          </table>
          </form>
        </DIV>
