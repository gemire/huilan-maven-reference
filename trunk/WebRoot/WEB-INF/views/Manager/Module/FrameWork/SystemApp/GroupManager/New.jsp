...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              ...
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：新增部门</td>
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='GroupList.aspx?GroupID=${param.pGroupID==null?'2':param.pGroupID}';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${ctx}/Manager/images/ICON/back.gif">&nbsp;返回</td></tr></table></td>
              </tr>
    ...
    <!-- 选项卡 Start -->
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${ctx}/Manager/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>新增部门</TD>
		...
		<form:form modelAttribute="newGroup">
        <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
            <tr>
	<td class="table_title" colspan="2">
                    <span id="ctl00_PageBody_CatListTitle">${grouptitle}</span></td>
</tr>
	...
	<td class="table_body">
                上级部门</td>
	<td class="table_none">
                <span id="ctl00_PageBody_G_ParentID_Txt">${sysGroup.gcname}</span></td>
</tr>
	...
	<td class="table_none" style="height: 25px">
	            <form:input path="gcname" Cssclass="text_input"/>
                <form:errors path="gcname" cssClass="error" />
                 </td>
</tr>
