...
<tr>
	...
	<Iframe  name="leftbody" 	style="HEIGHT: 100%; VISIBILITY: inherit; WIDTH: 198; Z-INDEX: 2" 	scrolling=auto frameborder=0 src="CatIndex" ></Iframe>
</td>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="11" height="100%" align="right">
		<tr>
			<td valign="middle" align="right" style="background-color:#FFFFFF;border-right:1px solid #C7C5D9;"><img border="0" src="${ctx}/Manager/images/Menu/close.gif" id="menuimg" alt="隐藏左栏" onmouseover="javascript: menuonmouseover();" onmouseout="javascript: menuonmouseout();"  onclick="javascript:switchSysBar()" style="cursor: hand" width="11" height="76"></td>
		</tr>
	</table>
    ...
    <td style="width:100%">
	<Iframe src="GroupList" name="mainbody" style="HEIGHT: 100%; VISIBILITY: inherit; WIDTH: 100%; Z-INDEX: 1" scrolling="auto" frameborder="0"></Iframe>
</td>
  </tr>
</table>
</body>
...
if (parent_frmTitle!=null)
{
		...
		parent_menuimg.src="${ctx}/Manager/images/Menu/close.gif";
...
if (parent_frmTitle!=null)
{
		...
		parent_menuimg.src="${ctx}/Manager/images/Menu/open.gif";
