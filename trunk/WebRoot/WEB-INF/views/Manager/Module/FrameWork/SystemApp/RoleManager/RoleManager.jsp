...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              ...
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：增加角色</td>
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='RoleList.aspx';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${ctx}/Manager/images/ICON/list.gif">&nbsp;列表角色</td></tr></table></td>
              </tr>
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${ctx}/Manager/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>增加角色</TD>
...
<form:form modelAttribute="sysRole">
<table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">		
		<tr>
			<td class="table_body">
                角色名称</td>
			<td class="table_none">                
                <form:input path="rroleName" Cssclass="text_input" size="50"/><span class="required">* 必填</span>
                <form:errors path="rroleName" cssClass="error" /></td>
		</tr>
		<tr>
			<td class="table_body">
                角色介绍</td>
