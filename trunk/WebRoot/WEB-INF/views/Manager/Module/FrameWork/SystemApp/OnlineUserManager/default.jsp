...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              <tr>
                <td class='menubar_title'><img border='0' src='${ctx}/Manager/images/ICON/online.gif' align='absmiddle' hspace='3' vspace='3'>&nbsp;在线用户列表</td>
                <td class='menubar_readme_text' valign='bottom'><img src='${ctx}/Manager/images/ICON/office.gif' align='absMiddle' border='0' />&nbsp;帮助？</td>
              </tr>
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：查看在线用户</td>
 ...
 <!-- 选项卡 Start -->
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${ctx}/Manager/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>在线用户列表</TD>
        ...
        <input type='hidden' ID='FrameWork_YOYO_LzppccSelectIndex' name='FrameWork_YOYO_LzppccSelectIndex' value='0'><!--内容框Start-->
		<DIV id='tabContent__0' style='display:none'>
            <div>
            <c:if test="${fn:length(activeUsers) > 0 }">
		...
		<tr class="table_title" align="center">
			<th scope="col">用户名</th><th scope="col">活跃时间</th><th scope="col">&nbsp;</th>
		</tr>
		<c:forEach items="${activeUsers}" var="uinfo" varStatus="status">
		<tr class="${status.count%2==0?"row1":"row"}" align="center" style="height:28px;">
    <td>${uinfo.key.username}</td>
    <td><fmt:formatDate value="${uinfo.value}" pattern="yyyy-M-dd HH:mm:ss"/></td>
    <td><input type="submit" name="ctl00$PageBody$GridView1$ctl02$Button1" value="下线" onclick="return confirm('确认要强制用户下线吗？');" class="button_bak" /></td>
  </tr>
  </c:forEach>
	</table>
...
<div id="ctl00_PageBody_AspNetPager1">
	<table width="100%" border="0" cellpadding="5" cellspacing="0">
		<tr>
			<td valign="bottom" align="left" nowrap="true" style="width:40%;">总记录：1  页码：1/1  每页：20</td><td valign="bottom" align="Right" nowrap="true" class="" style="width:60%;"><a disabled="true" style="margin-right:5px;">首页</a><a disabled="true" style="margin-right:5px;">上一页</a><span style="margin-right:5px;font-weight:Bold;color:red;">1</span><a disabled="true" style="margin-right:5px;">下一页</a><a disabled="true" style="margin-right:5px;">尾页</a></td>
		</tr>
	</table>
</div>
