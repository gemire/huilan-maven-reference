...
<!-- 头部菜单 Start -->
	        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
              <tr>
                <td class='menubar_title'><img border='0' src='${ctx}/Manager/images/ICON/applist.gif' align='absmiddle' hspace='3' vspace='3'>&nbsp;栏目信息管理</td>
                <td class='menubar_readme_text' valign='bottom'><img src='${ctx}/Manager/images/ICON/office.gif' align='absMiddle' border='0' />&nbsp;帮助？</td>
              </tr>
              <tr>
                <td height='27px' class='menubar_function_text'>目前操作功能：修改栏目信息</td>
                <td class='menubar_menu_td' align='right'><table border="0" cellspacing="0" cellpadding="0"><tr><td class="menubar_button" id="button_0" OnClick="JavaScript:window.location.href='List';" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${ctx}/Manager/images/ICON/list.gif">&nbsp;列表栏目信息</td><td class="menubar_button" id="button_1" OnClick="JavaScript:DelData('?cmd=del&IDX=626')" OnMouseOut="javascript:MenuOnMouseOver(this);" OnMouseOver="javascript:MenuOnMouseOut(this);"><img border="0" align="texttop" src="${ctx}/Manager/images/ICON/delete.gif">&nbsp;删除栏目信息</td></tr></table></td>
              </tr>
    ...
    <!-- 选项卡 Start -->
	        ...
	        <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
                       <TR>
				         ...
				         <TD class=tab id=tabLabel__0 onclick='javascript:tabClick(0,1)' background='${ctx}/Manager/images/Menu/tab_unactive_bg.gif' UNSELECTABLE='on'>修改内容</TD>
        ...
        <input type='hidden' ID='FrameWork_YOYO_LzppccSelectIndex' name='FrameWork_YOYO_LzppccSelectIndex' value='0'><!--内容框Start--><DIV id='tabContent__0' style='display:none'>
            ...
            <form:form modelAttribute="bizInfo">
...
<tr>
                    <td class="table_body" style="width: 18%">
                        主体</td>
                    <td class="table_none">
                     <form:input path="comp_id.infoSubject" cssClass="text_input" cssStyle="width:255px;"/>
                <form:errors path="comp_id.infoSubject" cssClass="error" />
                ...
                <tr>
                    <td class="table_body" style="width: 18%">
                        属性名</td>
                    <td class="table_none">
                     <form:input path="comp_id.infoKey" cssClass="text_input" cssStyle="width:255px;"/>
                <form:errors path="comp_id.infoKey" cssClass="error" />
                ...
                <tr>
                    <td class="table_body" style="width: 18%">
                        描述</td>
                    <td class="table_none">
                     <form:input path="infoDes" cssClass="text_input" cssStyle="width:255px;"/>
                <form:errors path="infoDes" cssClass="error" />
                ...
                <tr>
                    ...
                    <td class="table_none" colspan="2">
                        ...
                        <form:textarea path="infoValue" cssClass="text_input"/>
                <form:errors path="infoValue" cssClass="error" />
...
<script type="text/javascript">//<![CDATA[
var editor=CKEDITOR.replace('infoValue');
