...
<!-- 选项卡 Start -->
        ...
        <form:form modelAttribute="rp">        
        <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
		<tr>
			<td class="table_body">
                所属应用</td>
			<td class="table_none">
                <form:input path="papplicationId" cssClass="text_input"/>
                <form:errors path="papplicationId" cssClass="error" />
                </td>
		</tr>
				<tr>
			<td class="table_body">
                栏目名称</td>
			<td class="table_none">
               <form:input path="ppageCode" cssClass="text_input"/>
                <form:errors path="ppageCode" cssClass="error" />
               </td>
		</tr>
		<tr>
			<td class="table_body">
                所有权限</td>
			<td class="table_none">
			<form:checkboxes path="arraystr" items="${funcation}" cssClass="text_input"/>
                       <form:errors path="arraystr" cssClass="error" />                
                </td>
		</tr>
